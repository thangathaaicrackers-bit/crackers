...
export default function Admin() {
  ...
  const uploadData = (name, price, category, discount, image) => {
    ...
    axios
      .post(`${import.meta.env.VITE_FRONTEND_URL}/api/crackers`, formData, {
        headers: {
  ...
  const updateData = (id, name, price, category, discount, image) => {
    ...
    axios
      .put(
        `${import.meta.env.VITE_FRONTEND_URL}/api/crackers/${id}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDeleteClick = (id) => {
    if (window.confirm("Are you sure you want to delete this cracker?")) {
      axios
        .delete(`${import.meta.env.VITE_FRONTEND_URL}/api/crackers/${id}`)
        .then((res) => {
          if (res.status === 200) {
                ...
                <form onSubmit={handleSubmit(handleData)}>
                  ...
                  <div className="mb-3">
                    ...
                    >
                      ...
                      <option value="Single Sound Crackers">
                      ...
                      <option value="Multiple Color shots">
                        Multiple Color shots
                      </option>
                      <option value="Sparklers">Sparklers</option>
                      <option value="Special Sparklers">
                        Special Sparklers
                      </option>
